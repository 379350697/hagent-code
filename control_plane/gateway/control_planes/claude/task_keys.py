"""Task identity helpers for platform-isolated Claude sessions."""
...
def build_claude_task_key(request: CommandRequest) -> str:
    """Return the platform/chat/thread scoped key used for Claude tasks."""
