"""Persistent selected Claude session mapping."""
...
def claude_selection_path() -> str:
    home = os.environ.get("HERMES_HOME") or os.path.join(os.path.expanduser("~"), ".hermes")
    return os.path.join(home, "claude-control-plane", "selected_sessions.json")
...
class SelectedSessionStore:
    """Stores the current Claude session selected for each platform/chat/thread."""

    def __init__(self, path: str | None = None) -> None:
        self.path = path or claude_selection_path()
