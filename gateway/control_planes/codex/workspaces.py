"""Workspace discovery and per-chat workspace selection."""
...
def workspace_store_path() -> str:
    ...
    return os.path.join(home, "codex-control-plane", "workspaces.json")
...
def workspace_scan_roots(default_workspace: str = "") -> list[str]:
    env_value = (
        os.environ.get("HERMES_CODEX_WORKSPACE_ROOTS")
        or os.environ.get("CODEX_WORKSPACE_ROOTS")
        or ""
    )
